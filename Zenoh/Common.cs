...
namespace Zenoh
{
    ...
    public sealed class ZString : Loanable
    {
        ...
        internal override void CheckDisposed()
        {
            ...
            {
                throw new ObjectDisposedException(nameof(ZString));
            }
        }
    ...
    internal sealed class ViewString : IDisposable
    {
        ...
        internal void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(ViewString));
            }
        }
    ...
    public sealed class ZBytes : Loanable
    {
        ...
        internal override void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(ZBytes));
            }
        }
    ...
    public sealed class ZBytesReadStream : Stream
    {
        ...
        ~ZBytesReadStream() => Dispose(false);
        ...
        internal void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(ZBytesReadStream));
            }
        }
    ...
    public sealed class ZBytesWriteStream : Stream
    {
        ...
        ~ZBytesWriteStream() => Dispose(false);
        ...
        internal void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(ZBytesWriteStream));
            }
        }
    ...
    public sealed class ZSlice : Loanable
    {
        ...
        internal override void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(ZSlice));
            }
        }
    ...
    public sealed class Timestamp : IDisposable
    {
        ...
        public void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(Timestamp));
            }
        }
    ...
    public sealed class Keyexpr : Loanable
    {
        ...
        internal override void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(Keyexpr));
            }
        }
    ...
    public sealed class EntityGlobalId : IDisposable
    {
        ...
        public void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(EntityGlobalId));
            }
        }
    }
#endif
    ...
    public sealed class SourceInfo : Loanable
    {
        ...
        internal override void CheckDisposed()
        {
            if (Handle == IntPtr.Zero)
            {
                throw new ObjectDisposedException(nameof(SourceInfo));
            }
        }
