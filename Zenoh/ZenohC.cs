...
namespace Zenoh
{
    ...
    /// </summary>
    public enum BufLayoutAllocStatus
    {
        /// Allocation ok
        Ok = 0,
    ...
    // z_owned_shm_t
    [StructLayout(LayoutKind.Sequential, Pack = 8)]
    internal unsafe struct ZOwnedShm
    {
        private fixed byte data[80];
    }
    ...
    // z_owned_shm_mut_t
    [StructLayout(LayoutKind.Sequential, Pack = 8)]
    internal unsafe struct ZOwnedShmMut
    {
        private fixed byte data[80];
    }
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 8)]
    internal unsafe struct ZOwnedShmProvider
    {
        private fixed byte data[104];
    }

    // zenoh_opaque_h
    // z_owned_precomputed_layout_t
    [StructLayout(LayoutKind.Sequential, Pack = 8)]
    internal unsafe struct ZOwnedPrecomputedLayout
    {
        private fixed byte data[40];
    }
    ...
    // z_buf_alloc_result
    [StructLayout(LayoutKind.Sequential)]
    internal struct ZBufAllocResult
    {
        internal BufAllocStatus status;
        internal ZOwnedShmMut buf;
        internal AllocError error;
    }

    // zenoh_opaque.h
    // z_buf_layout_alloc_result_t 
    [StructLayout(LayoutKind.Explicit)]
    internal struct ZBufLayoutAllocResult
    {
        [FieldOffset(0)] internal BufLayoutAllocStatus status;
        [FieldOffset(8)] internal ZOwnedShmMut buf;
        [FieldOffset(88)] internal AllocError alloc_error;
        [FieldOffset(92)] internal LayoutError layout_error;
    }
    ...
    internal static class ZenohC
    {
        ...
        internal static extern Result z_get(IntPtr session, IntPtr keyexpr, IntPtr parameters, IntPtr callback,
            IntPtr options);
        ...
        //      const struct z_owned_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_internal_shm_mut_check", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.U1)]
        internal static extern bool z_internal_shm_mut_check(IntPtr shm);

        //  void
        //  z_internal_shm_mut_null(
        //      struct z_owned_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_internal_shm_mut_null", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_internal_shm_mut_null(IntPtr shm);

        //  void
        //  z_internal_shm_null(
        //      struct z_owned_shm_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_internal_shm_null", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_internal_shm_null(IntPtr shm);

        //  bool
        //  z_internal_precomputed_layout_check(
        //      const struct z_owned_precomputed_layout_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_internal_precomputed_layout_check",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.U1)]
        internal static extern bool z_internal_precomputed_layout_check(IntPtr layout);

        //  void
        //  z_internal_precomputed_layout_null(
        //      struct z_owned_precomputed_layout_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_internal_precomputed_layout_null",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_internal_precomputed_layout_null(IntPtr layout);

        //  bool
        //  z_internal_shm_provider_check(
        //      const struct z_owned_shm_provider_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_internal_shm_provider_check", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.U1)]
        internal static extern bool z_internal_shm_provider_check(IntPtr provider);

        //  void
        //  z_internal_shm_provider_null(
        //      struct z_owned_shm_provider_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_internal_shm_provider_null", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_internal_shm_provider_null(IntPtr provider);

        //  z_result_t
        //  z_posix_shm_provider_new(
        //      struct z_owned_shm_provider_t *this_,
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_posix_shm_provider_new", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_posix_shm_provider_new(IntPtr provider, UIntPtr size);
        ...
        //  )
        [DllImport(DllName, EntryPoint = "z_posix_shm_provider_with_layout_new",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_posix_shm_provider_with_layout_new(IntPtr provider, IntPtr layout);
        ...
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_default_new", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_shm_provider_default_new(IntPtr provider, UIntPtr size);

        //  size_t
        //  z_shm_provider_defragment(
        //      const struct z_loaned_shm_provider_t *provider
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_defragment", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern UIntPtr z_shm_provider_defragment(IntPtr provider);

        //  void
        //  z_shm_provider_drop(
        //      struct z_moved_shm_provider_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_drop", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_drop(IntPtr provider);

        //  size_t
        //  z_shm_provider_garbage_collect(
        //      const struct z_loaned_shm_provider_t *provider
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_garbage_collect", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern UIntPtr z_shm_provider_garbage_collect(IntPtr provider);

        //  const struct z_loaned_shm_provider_t*
        //  z_shm_provider_loan(
        //      const struct z_owned_shm_provider_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_loan", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_shm_provider_loan(IntPtr provider);

        //  void
        //  z_shm_provider_alloc(
        //      struct z_buf_layout_alloc_result_t *out_result,
        //      const struct z_loaned_shm_provider_t *provider,
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc(IntPtr result, IntPtr provider, UIntPtr size);
        ...
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_aligned", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_aligned(IntPtr result, IntPtr provider, UIntPtr size,
        ...
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_loan_gc", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_gc(IntPtr result, IntPtr provider, UIntPtr size);
        ...
        //      struct z_alloc_alignment_t alignment
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_gc_aligned", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_gc_aligned(IntPtr result, IntPtr provider, UIntPtr size,
            AllocAlignment alignment);
        ...
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_gc_defrag", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_gc_defrag(IntPtr result, IntPtr provider, UIntPtr size);
        ...
        //      struct z_alloc_alignment_t alignment
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_gc_defrag_aligned",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_gc_defrag_aligned(IntPtr result, IntPtr provider, UIntPtr size,
            AllocAlignment alignment);
        ...
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_gc_defrag_blocking",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_gc_defrag_blocking(IntPtr result, IntPtr provider,
            UIntPtr size);
        ...
        //      struct z_alloc_alignment_t alignment
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_gc_defrag_blocking_aligned",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_gc_defrag_blocking_aligned(IntPtr result, IntPtr provider,
            UIntPtr size, AllocAlignment alignment);
        ...
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_gc_defrag_dealloc",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void
            z_shm_provider_alloc_gc_defrag_dealloc(IntPtr result, IntPtr provider, UIntPtr size);
        ...
        //      struct z_alloc_alignment_t alignment
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_gc_defrag_dealloc_aligned",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_provider_alloc_gc_defrag_dealloc_aligned(IntPtr result, IntPtr provider,
            UIntPtr size, AllocAlignment alignment);
        ...
        //      size_t size
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_layout",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_shm_provider_alloc_layout(IntPtr result, IntPtr provider, UIntPtr size);
        ...
        //      struct z_alloc_alignment_t alignment
        // )
        [DllImport(DllName, EntryPoint = "z_shm_provider_alloc_layout_aligned",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_shm_provider_alloc_layout_aligned(IntPtr result, IntPtr provider,
            UIntPtr size, AllocAlignment alignment);
        ...
        //      const struct z_loaned_shm_provider_t *provider
        // )
        [DllImport(DllName, EntryPoint = "z_shm_provider_available",
            CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern UIntPtr z_shm_provider_available(IntPtr provider);

        //  const struct z_loaned_precomputed_layout_t*
        //  z_precomputed_layout_loan(
        //      const struct z_owned_precomputed_layout_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_precomputed_layout_loan", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_precomputed_layout_loan(IntPtr layout);

        //  void
        //  z_precomputed_layout_drop(
        //      struct z_moved_precomputed_layout_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_precomputed_layout_drop", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_precomputed_layout_drop(IntPtr layout);

        //  void
        //  z_precomputed_layout_alloc(
        //      struct z_buf_alloc_result_t *out_result,
        //      const struct z_loaned_precomputed_layout_t *layout
        //  )
        [DllImport(DllName, EntryPoint = "z_precomputed_layout_alloc", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_precomputed_layout_alloc(IntPtr result, IntPtr layout);
        ...
        //      const struct z_loaned_precomputed_layout_t *layout
        //  )
        [DllImport(DllName, EntryPoint = "z_precomputed_layout_alloc_gc", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_precomputed_layout_alloc_gc(IntPtr result, IntPtr layout);
        ...
        //      const struct z_loaned_precomputed_layout_t *layout
        //  )
        [DllImport(DllName, EntryPoint = "z_precomputed_layout_alloc_gc_defrag",
            CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void z_precomputed_layout_alloc_gc_defrag(IntPtr result, IntPtr layout);
        ...
        //      const struct z_loaned_precomputed_layout_t *layout
        //  )
        [DllImport(DllName, EntryPoint = "z_precomputed_layout_alloc_gc_defrag_blocking",
            CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void z_precomputed_layout_alloc_gc_defrag_blocking(IntPtr result, IntPtr layout);
        ...
        //      const struct z_loaned_precomputed_layout_t *layout
        //  )
        [DllImport(DllName, EntryPoint = "z_precomputed_layout_alloc_gc_defrag_dealloc",
            CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void z_precomputed_layout_alloc_gc_defrag_dealloc(IntPtr result, IntPtr layout);
        ...
        //  )
        [DllImport(DllName, EntryPoint = "z_bytes_from_shm", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_bytes_from_shm(IntPtr zbytes, IntPtr shm);
        ...
        //  )
        [DllImport(DllName, EntryPoint = "z_bytes_from_shm_mut", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_bytes_from_shm_mut(IntPtr zbytes, IntPtr shm);
        ...
        //  )
        [DllImport(DllName, EntryPoint = "z_bytes_as_loaned_shm", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_bytes_as_loaned_shm(IntPtr bytes, IntPtr dst);

        //  z_result_t
        //  z_bytes_as_mut_loaned_shm(
        //      struct z_loaned_bytes_t *this_,
        //      struct z_loaned_shm_t **dst
        //  )
        [DllImport(DllName, EntryPoint = "z_bytes_as_mut_loaned_shm", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern Result z_bytes_as_mut_loaned_shm(IntPtr bytes, IntPtr dst);

        //  struct z_loaned_shm_mut_t*
        //  z_shm_try_reloan_mut(
        //      struct z_loaned_shm_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_try_reloan_mut", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_shm_try_reloan_mut(IntPtr shm);

        //  const unsigned char*
        //  z_shm_mut_data(
        //      const struct z_loaned_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_mut_data", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_shm_mut_data(IntPtr shm);

        //  unsigned char*
        //  z_shm_mut_data_mut(
        //      struct z_loaned_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_mut_data_mut", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_shm_mut_data_mut(IntPtr shm);

        //  size_t
        //  z_shm_mut_len(
        //      const struct z_loaned_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_mut_len", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern UIntPtr z_shm_mut_len(IntPtr shm);

        //  const struct z_loaned_shm_t*
        //  z_shm_loan(
        //      const struct z_owned_shm_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_loan", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_shm_loan(IntPtr shm);

        //  void
        //  z_shm_clone(
        //      struct z_owned_shm_t *out,
        //      const struct z_loaned_shm_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_clone", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_clone(IntPtr owned, IntPtr loaned);

        //  void
        //  z_shm_drop(
        //      struct z_moved_shm_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_drop", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_drop(IntPtr shm);

        //  void
        //  z_shm_mut_drop(
        //      struct z_moved_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_mut_drop", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern void z_shm_mut_drop(IntPtr shm);

        //  const struct z_loaned_shm_mut_t*
        //  z_shm_mut_loan(
        //      const struct z_owned_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_mut_loan", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_shm_mut_loan(IntPtr shm);

        //  struct z_loaned_shm_mut_t*
        //  z_shm_mut_loan_mut(
        //      struct z_owned_shm_mut_t *this_
        //  )
        [DllImport(DllName, EntryPoint = "z_shm_mut_loan_mut", CallingConvention = CallingConvention.Cdecl,
            ExactSpelling = true)]
        internal static extern IntPtr z_shm_mut_loan_mut(IntPtr shm);
#endif
    }
}